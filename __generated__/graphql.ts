...
// File generated at: 2021-12-22T14:42:48-08:00
...
export type PostDetailsFragment = { __typename?: 'Discussion', id: string, title: string, lastEditedAt?: any | null | undefined, url: any, body: string, labels?: { __typename?: 'LabelConnection', nodes?: Array<{ __typename?: 'Label', id: string, name: string, description?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, author?: { __typename?: 'Bot', avatarUrl: any } | { __typename?: 'EnterpriseUserAccount', avatarUrl: any } | { __typename?: 'Mannequin', avatarUrl: any } | { __typename?: 'Organization', avatarUrl: any } | { __typename?: 'User', id: string, name?: string | null | undefined, avatarUrl: any } | null | undefined };

export type SelectRecentlyCreatedPostsQueryVariables = Exact<{
  first?: InputMaybe<Scalars['Int']>;
  after?: InputMaybe<Scalars['String']>;
}>;


export type SelectRecentlyCreatedPostsQuery = { __typename?: 'Query', repository?: { __typename?: 'Repository', discussions: { __typename?: 'DiscussionConnection', totalCount: number, nodes?: Array<{ __typename?: 'Discussion', id: string, title: string, lastEditedAt?: any | null | undefined, url: any, body: string, labels?: { __typename?: 'LabelConnection', nodes?: Array<{ __typename?: 'Label', id: string, name: string, description?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, author?: { __typename?: 'Bot', avatarUrl: any } | { __typename?: 'EnterpriseUserAccount', avatarUrl: any } | { __typename?: 'Mannequin', avatarUrl: any } | { __typename?: 'Organization', avatarUrl: any } | { __typename?: 'User', id: string, name?: string | null | undefined, avatarUrl: any } | null | undefined } | null | undefined> | null | undefined, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null | undefined, hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null | undefined } } } | null | undefined };

export type SelectPostsWithQueryQueryVariables = Exact<{
  query: Scalars['String'];
  first?: InputMaybe<Scalars['Int']>;
  after?: InputMaybe<Scalars['String']>;
}>;
...
export const PostDetailsFragmentDoc = gql`
  ...
  body
    ...
    `;
export const SelectRecentlyCreatedPostsDocument = gql`
...
export const SelectPostsWithQueryDocument = gql`
    query SelectPostsWithQuery($query: String!, $first: Int = 1, $after: String) {
  search(first: $first, after: $after, type: DISCUSSION, query: $query) {
    nodes {
      ... on Discussion {
        ...PostDetails
      }
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    SelectRecentlyCreatedPosts(variables?: SelectRecentlyCreatedPostsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<SelectRecentlyCreatedPostsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SelectRecentlyCreatedPostsQuery>(SelectRecentlyCreatedPostsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'SelectRecentlyCreatedPosts');
    },
    SelectPostsWithQuery(variables: SelectPostsWithQueryQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<SelectPostsWithQueryQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SelectPostsWithQueryQuery>(SelectPostsWithQueryDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'SelectPostsWithQuery');
    }
  };
}
