  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 469.1 126.99">
    <g id="logo" data-name="logo">
      ...
      <g id="codedrift" data-name="codedrift">
        <path
          className={Logo.CLASS_NAMES.word.code.c}
          style={styles.code}
        ...
        />
        <path
          className={Logo.CLASS_NAMES.word.code.o}
          style={styles.code}
        ...
        />
        <path
          className={Logo.CLASS_NAMES.word.code.d}
          style={styles.code}
        ...
        />
        <polygon
          className={Logo.CLASS_NAMES.word.code.e}
          style={styles.code}
        ...
        />
        <path
          className={Logo.CLASS_NAMES.word.drift.d}
          style={styles.drift}
        ...
        />
        <path
          className={Logo.CLASS_NAMES.word.drift.r}
          style={styles.drift}
        ...
        />
        <rect
          className={Logo.CLASS_NAMES.word.drift.i}
          style={styles.drift}
          x="383.5"
          y="21.63"
          width="11.2"
        ...
        />
        <polygon
          className={Logo.CLASS_NAMES.word.drift.f}
          style={styles.drift}
        ...
        />
        <polygon
          className={Logo.CLASS_NAMES.word.drift.t}
          style={styles.drift}
