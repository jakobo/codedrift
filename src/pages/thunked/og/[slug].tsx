...
const ThunkedBySlugImage: React.FC<ThunkedBySlugImageProps> = () => {
  ...
  return (
    <>
      <NextSeo noindex nofollow title={`og:image for "${post.title}"`} />
      <div
      ...
      >
        <div className="relative w-full h-full">
          ...
          <div className="absolute top-0 left-0 right-0 bg-gray-600 h-6" />
          <div className="absolute bottom-0 left-0 right-0 bg-gray-700 h-16" />
