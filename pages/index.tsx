      ...
      <div className="w-full flex-shrink-0 flex-col lg:w-auto">
        <div className="max-w-reading mx-2 lg:mx-0">
          ...
          <p className="mt-3 font-sans">
            ...
            I write about{" "}
            <Link href="/thunked/tag/%F0%9F%93%9A%20Code" className={linkClasses}>
              code
            </Link>{" "}
            and the{" "}
            <Link href="/thunked/tag/%F0%9F%93%9A%20Leadership" className={linkClasses}>
              people
            </Link>{" "}
              ...
              <div className="font-sans text-sm">
                ...
                {post.tags.map((tag, idx) => (
                  <span key={tag.id} className={dullLinkClasses}>
                    {idx !== 0 ? ", " : null}
                    <Link href={`/thunked/tag/${tag.name}`} passHref className={dullLinkClasses}>
